              ...
              <button
                ...
                onClick={() => {
                  sessionStorage.setItem(
                    `tenant-announcement-popup-${announcement.id}`,
                    'dismissed'
                  )
                  setPopupOpen(false)
                }}
                className="absolute top-3 right-3 z-10 rounded-full bg-black/40 p-2 text-white transition-colors hover:bg-black/60"
...
function AnnouncementText({
  ...
  return (
    <div>
      <p className="mb-2 text-xs font-black tracking-[0.2em] text-[var(--accent)] uppercase">
        Anuncio
      </p>
