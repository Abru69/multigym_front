...
import { Plus, Utensils, Edit2, Trash2, Clock, User } from 'lucide-react'
      ...
      <AdminHeader
        ...
        action={
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-[var(--accent)] px-4 py-2.5 text-sm font-bold text-[var(--accent-text)] transition-all hover:opacity-90 active:scale-[0.97]"
          >
            <Plus size={16} />
            Nuevo Plan
          </button>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-[var(--text-muted)]">
                          {meal.time} — {meal.foods.length} alimento
