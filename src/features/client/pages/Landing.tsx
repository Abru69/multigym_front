            ...
            {isAuthenticated ? (
              <div className="relative">
                <Button 
                  ...
                  className="pl-3 pr-4 py-2 rounded-lg gap-2 text-white hover:border-accent"
                >
            ...
            <motion.div variants={heroItem} className="flex flex-col sm:flex-row items-center gap-5 w-full sm:w-auto">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                <Button
                  ...
                  className="px-10 h-14 w-full sm:w-auto uppercase tracking-wider gap-3 shadow-glow text-sm font-bold"
                >
                  {ctaText}
