          ...
          <div className="mt-auto space-y-4">
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="flex-1 h-14 rounded-xl flex items-center justify-center gap-2 font-bold transition-all disabled:opacity-50"
                style={{ background: "var(--accent)", color: "var(--accent-text)" }}
                onMouseEnter={(e) => { if (product.isAvailable) e.currentTarget.style.background = "var(--accent-hover)" }}
                onMouseLeave={(e) => { if (product.isAvailable) e.currentTarget.style.background = "var(--accent)" }}
              >
