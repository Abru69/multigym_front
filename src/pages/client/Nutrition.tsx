              ...
              >
                <div className="flex items-start gap-4">
                  <button 
                    ...
                    className="mt-1 text-text-muted hover:text-accent transition-colors"
                  >
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {Array.from({ length: 8 }).map((_, i) => (
                <button
                  ...
                  className={`w-10 h-12 rounded-lg flex items-center justify-center transition-all ${
                    i < waterGlasses 
                      ? "bg-blue-500/20 text-blue-400 border border-blue-500/30" 
                      : "bg-background text-text-muted border border-border hover:border-blue-500/20"
                  }`}
                >
