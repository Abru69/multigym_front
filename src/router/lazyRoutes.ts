...
export const Sales = lazy(() => import('@/features/admin/pages/Sales'))
...
export const NutritionFoodCatalog = lazy(() => import('@/features/admin/pages/NutritionFoodCatalog'))
export const NutritionRecipes = lazy(() => import('@/features/admin/pages/NutritionRecipes'))
export const NutritionEquivalences = lazy(() => import('@/features/admin/pages/NutritionEquivalences'))
...
export const PlatformMercadoPago = lazy(() => import('@/features/platform/pages/PlatformMercadoPago'))
