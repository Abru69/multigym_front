...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'mercadopago', element: withSuspense(PlatformMercadoPago) },
  ...
  // Admin Routes
  {
    ...
    children: [
      ...
      { path: 'ventas', element: <RoleGuard page="sales">{withSuspense(Sales)}</RoleGuard> },
      { path: 'recogidas', element: <Navigate to="/admin/ventas" replace /> },
      { path: 'envios', element: <Navigate to="/admin/ventas" replace /> },
      {
        path: 'entrega',
